...
def add_obj_meta(frame_meta,batch_meta,boxes,confs,acts_label=None,acts_conf=None):
    ...
    for i,(box,conf) in enumerate(zip(boxes,confs)):
        ...
        if acts_conf is not None:
            text_params.display_text = "act:{}".format(acts_label[i])
